...
class Solver(object):
    ...
    def evolve_to_time(self, solution, tend=None):
        ...
        """
        flag=0 # Initialize flag for quitting solver
        ...
        for n in range(self.max_steps):
            ...
            if self.before_step is not None:
                TT= self.before_step(self, solution.states[0])
                #print(TT)
                # if(TT=="Get out"):
                #     print(TT)
                #     flag=1
            ...
            # To check if shock exists or not: need to have a b4step code written out
            if self.before_step is not None:
                if(TT=="Get out"):
                    print(TT)
                    flag=1
